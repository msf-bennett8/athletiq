...
import { Button, TextInput, Text, Surface, Avatar, Divider, List, Switch, Menu, IconButton, Chip, ProgressBar } from 'react-native-paper';
        ...
        <Surface style={styles.infoCard}>
          ...
          <View style={styles.preferenceItem}>
            ...
            <View style={styles.preferenceContent}>
              ...
              <Text style={styles.preferenceDescription}>Receive training reminders and updates</Text>
            </View>
            <Switch
              value={preferences.notifications}
              onValueChange={(value) => handlePreferenceChange('notifications', value)}
              thumbColor={preferences.notifications ? '#10B981' : '#CBD5E1'}
          ...
          <View style={styles.preferenceItem}>
            ...
            <View style={styles.preferenceContent}>
              ...
              <Text style={styles.preferenceDescription}>Get weekly progress reports via email</Text>
            </View>
            <Switch
              value={preferences.emailUpdates}
              onValueChange={(value) => handlePreferenceChange('emailUpdates', value)}
              thumbColor={preferences.emailUpdates ? '#10B981' : '#CBD5E1'}
              trackColor={{ false: '#E5E7EB', true: '#BBF7D0' }}
            />
          </View>
        </Surface>
...
/>
      ...
      <ConfirmDialog
        ...
        message="⚠️ This action cannot be undone. All your data, progress, and account information will be permanently deleted. Are you absolutely sure?"
        onCancel={() => setShowDeleteModal(false)}
        onConfirm={handleDelete}
        confirmLabel="Delete Forever"
        cancelLabel="Keep Account"
        confirmColor={COLORS.error}
        icon={<Icon name="delete-forever" size={48} color={COLORS.error} />}
      />
    </View>
  );
};
